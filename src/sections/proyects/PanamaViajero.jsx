...
function PanamaViajero() {
    return (
        <article className="relative overflow-hidden bg-gradient-to-r from-[#4956A2] to-[#000000]">
            ...
            <div className="grid min-h-[520px] lg:grid-cols-[0.78fr_1.22fr]">
                <div className="relative z-10 flex flex-col justify-center px-6 py-10 sm:px-10 lg:px-12 xl:px-16">
                    <span aria-hidden="true" className="text-md font-bold leading-none text-[#AAC551] sm:text-md">
                        TURISMO DIGITAL
                    </span>
                    <h3 className="text-4xl font-bold tracking-tight  sm:text-5xl mt-2">
                        Panamá Viajero
                    </h3>
                    <span aria-hidden="true" className="mb-7 mt-4 h-0.5 w-20 bg-[#CD2E4C]" />
                    ...
                    <ul className="mt-5 flex flex-col gap-3" aria-label="Servicios desarrollados">
                        <div className="flex gap-3">
                            ...
                            <li
                                key={name}
                                className="flex items-center gap-2 rounded-full border border-[#AAC551]/55 px-4 py-2 text-[11px] font-bold uppercase tracking-[0.08em] text-white/75"
                            >
                        ...
                        <div className="mt-15">
                            <a href="https://panamaviajero.app/" target="blank" className="rounded-full bg-[#CD2E4C]/90 py-3 px-4 text-white 
                            hover:bg-transparent hover:border-2 hover:border-[#FFFFFF] hover:text-white/90 border-2 border-[#CD2E4C]
