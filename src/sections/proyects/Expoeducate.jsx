...
function ExpoEducateSuperior() {
    return (
        <article className="relative overflow-hidden bg-gradient-to-r from-[#FFFFFF] to-[#F39200]">
            ...
            <div className="grid min-h-[520px] lg:grid-cols-[0.78fr_1.22fr]">
                <div className="relative z-10 flex flex-col justify-center px-6 py-10 sm:px-10 lg:px-12 xl:px-16">
                    <span aria-hidden="true" className="text-md font-bold leading-none text-[#000000]/90 sm:text-md">
                        EVENTO EDUCATIVO
                    </span>
                    <h3 className="text-4xl font-bold tracking-tight  sm:text-5xl mt-2 text-[#000000]/90">
                        Expo Edúcate <br />
                        Superior
                    </h3>
                    <span aria-hidden="true" className="mb-7 mt-4 h-0.5 w-20 bg-[#F39200]" />

                    <p className="max-w-lg text-sm leading-7 text-[#000000]/90 sm:text-base ">
                        Un evento para que los estudiantes de bachillerato escojan su universidad y conozcan 
                        todas las posibilidades que les ofrecen las diferentes universidades.
                    </p>
                    ...
                    <ul className="mt-5 flex flex-col gap-3" aria-label="Servicios desarrollados">
                        <div className="flex gap-3">
                            ...
                            <li
                                ...
                                px-4 py-2 text-[11px] font-bold uppercase tracking-[0.08em] text-[#000000]/90"
                            >
                                <Icon aria-hidden="true" className="h-4 w-4 text-[#000000]/90" strokeWidth={1.6} />
                                {name}
                            </li>
                        ))}
                        </div>
                        <div className="mt-15">
                            <a href="https://www.instagram.com/expoeducatesuperior" target="blank" className="rounded-full bg-[#F39200]/90 py-3 px-4 text-white 
...
export default ExpoEducateSuperior;
