        ...
        <article className="relative overflow-hidden ">
            ...
            <div className="grid min-h-[520px] lg:grid-cols-[0.78fr_1.22fr]">
                <div className="relative z-10 flex flex-col  px-6 py-10 sm:px-10 lg:px-12 xl:px-16">
                    ...
                    <p className="max-w-lg text-sm leading-7 text-[#FFFFFF]/90 sm:text-base ">
                    ...
                    <ul className="mt-5 flex flex-col gap-3" aria-label="Servicios desarrollados">
                        <div className="flex gap-3">
                            ...
                            <li
                                key={name}
                                className="flex items-center gap-2 rounded-full border border-[#AAC551] 
                                px-4 py-2 text-[11px] font-bold uppercase tracking-[0.08em] hover:scale-103 text-[#FFFFFF]/90
                                transition duration-300"
                            >
                                <Icon aria-hidden="true" className="h-4 w-4 text-[#AAC551]/90" strokeWidth={1.6} />
                                {name}
                            </li>
                        ))}
                        </div>
                        <div className="mt-15">
                            <a href="https://www.instagram.com/expoeducatesuperior" target="blank" className="rounded-full bg-[#AAC551]/90 py-3 px-4 text-white 
                ...
                <div className="project-visual relative flex min-h-[360px] items-center justify-center  p-6 sm:p-10 lg:min-h-full ">
                    ...
                    <img
                        src="/proyects/expoEducate/Expoeducate.svg"
