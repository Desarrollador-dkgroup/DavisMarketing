...
function HeroCinematic() {
  ...
  return (
    ...
    >
      ...
      <div className=" pointer-events-none absolute inset-x-0 top-[64%] z-20 px-5 text-center sm:top-[66%]"> {/* cinematic-brand-copy */}
        <p className=" text-[clamp(3rem,5vw,4.6rem)] font-extrabold leading-none tracking-[0.035em] text-[#1C3D72]"> {/* cinematic-brand-name */}
          DAVIS MARKETING
        </p>
        <p className="  mt-2 text-[clamp(2rem,2.9vw,2.9rem)] font-normal leading-none tracking-[0.08em] text-[#1C3D72]"> {/* cinematic-brand-subtitle */}
