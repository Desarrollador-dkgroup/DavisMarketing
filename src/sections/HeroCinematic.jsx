  ...
  return (
    ...
    >
      ...
      md:mt-0 md:t-[-30px] md:top-[64%] z-20 px-5 text-center "> {/* cinematic-brand-copy */}
        ...
        font-extrabold leading-none tracking-[0.035em] text-[#1C3D72]"> {/* cinematic-brand-name */}
          DAVIS MARKETING
        </p>
        <p className="cinematic-brand-subtitle  mt-2 text-[clamp(1.3rem,5vw,6rem)] md:text-[clamp(2rem,2.9vw,2.9rem)] font-normal leading-none tracking-[0.08em] text-[#1C3D72]"> {/* cinematic-brand-subtitle */}
